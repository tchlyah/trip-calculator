...
public class CSVTripAdapterTest {
    ...
    void should_write_csv_file() throws Exception {
        List<Trip> trips = List.of(
                new Trip(DateUtils.parse("22-01-2018 13:00:00"), DateUtils.parse("22-01-2018 13:05:00"), 900, "Stop1", "Stop2", 3.25d, "Campany1", "B37", "5500005555555559", TripStatus.COMPLETED));
